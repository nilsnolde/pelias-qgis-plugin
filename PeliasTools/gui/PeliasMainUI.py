...
class Ui_PeliasMainDialog(object):
    def setupUi(self, PeliasMainDialog):
        ...
        self.search_rest_circle_clear.setMaximumSize(QtCore.QSize(66, 25))
        self.search_rest_circle_clear.setObjectName("search_rest_circle_clear")
        self.gridLayout_7.addWidget(self.search_rest_circle_clear, 0, 5, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.search_rest_rect_clear, 1, 0, 1, 1)
        ...
        self.search_focus_clear.setMaximumSize(QtCore.QSize(66, 25))
        self.search_focus_clear.setObjectName("search_focus_clear")
        self.horizontalLayout.addWidget(self.search_focus_clear)
        ...
        self.search_tab.setCurrentIndex(1)
    ...
    def retranslateUi(self, PeliasMainDialog):
        ...
        PeliasMainDialog.setWindowTitle(_translate("PeliasMainDialog", "Pelias Forward Search"))
        self.label_13.setText(_translate("PeliasMainDialog", "<html><head/><body><div style=\"line-height: 150%\"><p><span style=\" font-weight:600;\">Note</span>, address expansion is not supported at this time, i.e. Main Street/Hauptstraße instead of Main St/Haupstr..</p></div></body></html>"))
