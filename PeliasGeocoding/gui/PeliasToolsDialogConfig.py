...
from .PeliasToolsConfigUI import Ui_PeliasToolsDialogConfigBase
from PeliasGeocoding.utils import configmanager


class PeliasToolsDialogConfigMain(QDialog, Ui_PeliasToolsDialogConfigBase):
